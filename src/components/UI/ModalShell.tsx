...
// Previously defined inline, only in MobileNav. Used by:
//   ImportModulesModal, ImportTestsModal, ImportStepsModal, ImportStepsManualModal
// Now reusable across the whole app.
...
const ModalShell: React.FC<Props> = ({ title, subtitle, icon, onClose, children }) => (
  <div className="fixed inset-0 z-70 flex items-end md:items-center justify-center">
    {/* Backdrop */}
    <div className="absolute inset-0 bg-black/50" onClick={onClose} />

    {/* Sheet */}
    <div className="relative w-full md:max-w-md mx-auto bg-bg-surface/80 backdrop-blur-md
      border-t md:border border-[var(--border-color)] rounded-t-2xl md:rounded-2xl
